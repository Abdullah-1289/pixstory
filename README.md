...
- **CSV files** with BLEU-1 and BLEU-4 scores in `results/`
- **Console output** with qualitative caption examples
...
|-----------|---------------|
| First run (dataset download) | ~5 minutes |
| Per experiment (GPU) | ~30 minutes |
| Per experiment (CPU) | ~2 hours |
| **Total (all 3 experiments)** | **1.5-6 hours** |
