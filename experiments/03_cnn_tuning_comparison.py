...
from config import *
from src.utils import get_data_loaders, CNNEncoder, DecoderGRU, Trainer, Evaluator
...
def run_cnn_tuning_experiment():
    ...
    for strategy_name, fine_tune, epochs in tuning_strategies:
        ...
        evaluator = Evaluator(encoder, decoder, idx2word, word2idx, DEVICE)
        bleu1, bleu4, num_samples = evaluator.evaluate_bleu(test_loader)
        ...
        train_evaluator = Evaluator(encoder, decoder, idx2word, word2idx, DEVICE)
        train_bleu1, train_bleu4, _ = train_evaluator.evaluate_bleu(train_loader, max_samples=500)
